...
const TimelineStep = ({ step,order, isCompleted, isCurrent, isLastStep, icon, description }) => {
  const showBg = isCompleted || isCurrent ? icon.bgColor : 'bg-gray-100';
  const showText = isCompleted || isCurrent ? icon.textColor : 'text-gray-500';
  ...
  return (
    <li className="relative mb-6 sm:mb-0 sm:pl-10">
      <div className="flex items-center">
        <div className={`z-10 flex items-center justify-center w-8 h-8 rounded-full ring-0 ring-white shrink-0 ${showBg} ${showText}`}>
